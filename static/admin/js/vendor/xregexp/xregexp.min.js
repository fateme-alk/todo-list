                            ...
                            function (b, c, h) {
                                ...
                                if ('P' === b[1] && b[2])
                                    throw new SyntaxError(
                                        'Invalid double negation ' + b[0],
                                    );
                                if (!l.hasOwnProperty(h))
                                    throw new SyntaxError(
                                        'Unknown Unicode token ' + b[0],
                                    );
                                if (k.inverseOf) {
                                    h = g(k.inverseOf);
                                    if (!l.hasOwnProperty(h))
            ...
            9: [
                function (d, g, p) {
                    ...
                    function h(a, e) {
                        ...
                        if (B(e) !== e)
                            throw new SyntaxError(
                                'Invalid duplicate regex flag ' + e,
                            );
                        a = n.replace.call(
                            a,
                            /^\(\?([\w$]+)\)/,
                    ...
                    function f(a, e) {
                        ...
                        if (!F[a][e]) {
                            ...
                            F[a][e] = {
                                pattern: n.replace.call(
                                    d,
                                    /(?:\(\?:\))+/g,
                                    '(?:)',
                                ),
                                flags: n.replace.call(E, /[^gimuy]+/g, ''),
                                captures: b.hasNamedCapture
                                    ? b.captureNames
                                    : null,
                            };
                        }
                    ...
                    f.union = function (a, b, c) {
                        ...
                        for (
                            ...
                            if (((k = a[l]), f.isRegExp(k))) {
                                ...
                                h.push(
                                    n.replace.call(f(k.source).source, g, d),
                                );
                        ...
                        if (c) {
                            ...
                            if (this.xregexp && this.xregexp.captureNames)
                                for (d = 1; d < c.length; ++d)
                                    (f = this.xregexp.captureNames[d - 1]) &&
                                        (c[f] = c[d]);
                            this.global &&
                                !c[0].length &&
                    ...
                    f.addToken(
                        ...
                        function (a, b, c) {
                            ...
                            if (1114111 < b)
                                throw new SyntaxError(
                                    'Invalid Unicode code point ' + a[0],
                                );
